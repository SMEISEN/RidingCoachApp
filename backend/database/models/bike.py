...
class BikeModel(db.Model):
    ...
    slick_front_pressure = db.Column(JSON, nullable=True)
    slick_rear_name = db.Column(db.String(50), nullable=True)
    slick_rear_pressure = db.Column(JSON, nullable=True)
    rain_front_name = db.Column(db.String(50), nullable=True)
    rain_front_pressure = db.Column(JSON, nullable=True)
    rain_rear_name = db.Column(db.String(50), nullable=True)
    rain_rear_pressure = db.Column(JSON, nullable=True)
